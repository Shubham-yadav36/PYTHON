...
class View:
    def __init__(self, top=None):
        ...
        top.geometry("687x526+358+80")
        top.title("Listen MP3")
    ...
    def setup_player(self):
        ...
        self.top.title("ListenMp3 - Listen Music That Touch Your Heart.")
    ...
    def remove_song(self):
        ...
        try:
            if len(self.sel_song_index_tuple) == 0:
                raise NoSongSelectedError("Please Select The Song To Remove.")
